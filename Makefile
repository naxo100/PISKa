...
OCAMLOPT = $(OCAMLBINPATH)ocamlopt.opt -I `$(OCAMLC) -where`/ocamlmpi unix.cmxa mpi.cmxa str.cmxa -ccopt -L$(HOME)/usr/lib -cclib -lmpich -cclib -lmpl -cclib -lopa #-g -ccopt -g -ccopt -pg
